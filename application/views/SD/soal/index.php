            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select id="nama_paket_sd" class="form-control" name="nama_paket_sd" onchange="inputKunciSD()" required>
                    ...
                    <div class="form-group">
                        ...
                        <select id="no_soal_sd" class="form-control" name="no_soal_sd" onchange="inputNoSoalSd()" required>
